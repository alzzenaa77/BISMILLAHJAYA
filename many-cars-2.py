...
# Tambahkan di awal
jumlah_kendaraan = 15  # bisa diganti ke 5, 10, 15, dst

# Tabel kecepatan berdasarkan jumlah kendaraan
kecepatan_tabel = {
    5: 91.9,
    10: 46.5,
    15: 31.9,
    ...
    def check_speedbump_log(self):
        ...
        if not self.already_logged and wheel_front_x > speedbump_x + speedbump_width:
            ...
            if self.kecepatan_terukur:                
                with open("log_kecepatan_banyak_15_005.csv", "a", newline="") as f:
                    writer = csv.writer(f)
                    writer.writerow([
...
for i in range(jumlah_kendaraan):
    speed = generate_speed(jumlah_kendaraan)
...
# Logging ke file CSV
csv_file_path = "log_kecepatan_banyak_15_005.csv"
...
while running:
    ...
    for car in cars:
        if car.x > WIDTH:
            ...
            car.speed = generate_speed(jumlah_kendaraan)
